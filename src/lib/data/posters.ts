...
export const servicePosters: ServicePoster[] = [
  ...
  },
  {
    ...
    category: "Health Screenings",
    description:
      "Medical examination required for new GDL (Goods Driving Licence) or PSV (Public Service Vehicle) licence applicants. JPJ-compliant, results issued same day.",
    details: [
      "Pemeriksaan Kesihatan Asas oleh Doktor",
      "Berat, Tinggi & BMI",
      "Pemeriksaan Fizikal & Mata",
      "Pemeriksaan Tekanan Darah",
      "Pemeriksaan Koordinasi Badan",
      "Konsultasi Doktor",
      "Tambahan jika perlu: Pemeriksaan Darah HbA1C (RM35)",
    ],
    whatsappNumber: "60162235212",
  },
  {
    ...
    category: "Health Screenings",
    description:
      "Pakej saringan kesihatan komprehensif untuk lelaki berumur 40 tahun ke atas. Merangkumi saringan kanser, jantung, buah pinggang dan banyak lagi. Termasuk bonus konsultasi fisioterapi percuma.",
    details: [
      "Saringan Kesihatan Standard",
      "Ujian Keradangan Darah (ESR)",
      "Saringan Kuman Hepatitis A",
      "Saringan Kuman Perut (H.Pylori Antibody)",
      "Pemeriksaan Risiko Sakit Jantung (hs-TRP T)",
      "Pemeriksaan Kebocoran Buah Pinggang",
      "Zarah Lipoprotein (a) — penyebab sakit jantung",
      "Saringan Kanser: AFP (Hati), CEA (Usus), Ca19.9 (Pancreas), PSA (Prostate)",
      "Percuma: Konsultasi Doktor, Pemeriksaan Fizikal, BMI, Mata & Komposisi Badan",
      "Percuma: Pemeriksaan Jantung (ECG) & X-Ray Dada",
      "Bonus Percuma: 1 Sesi Konsultasi Fisioterapi (20 minit)",
      "Digalakkan untuk lelaki berumur 40 tahun ke atas",
    ],
    whatsappNumber: "60162235212",
  },
  {
  ...
  },
  {
    ...
    category: "Health Screenings",
    description:
      "Optional add-on tests to enhance any health screening package. Choose the tests most relevant to your health needs — each available individually at affordable rates.",
    details: [
      "X-Ray serta CD — RM40",
      "Report Pakar — RM25",
      "Pap Smear Surepath — RM55",
      "Saringan Vitamin D — RM90",
      "Kanser Hidung (EBV VCA) — RM55",
      "Keradangan Darah (hs-CRP) — RM20",
      "Saringan Najis Berdarah (OBT) — RM70",
      "Saringan Darah Hormone Thyroid (TSH) — RM25",
      "Kanser Marker — RM20/test",
    ],
    whatsappNumber: "60162235212",
  },
  {
  ...
  },
  {
    ...
    category: "Health Screenings",
    description:
      "Pakej saringan kesihatan komprehensif untuk wanita berumur 40 tahun ke atas. Merangkumi saringan kanser wanita, jantung, buah pinggang dan banyak lagi. Termasuk Pap Smear dan bonus konsultasi fisioterapi percuma.",
    details: [
      "Saringan Kesihatan Standard",
      "Ujian Keradangan Darah (ESR)",
      "Saringan Kuman Hepatitis A",
      ...
      "Pemeriksaan Kebocoran Buah Pinggang",
      "Zarah Lipoprotein (a) — penyebab sakit jantung",
      "Saringan Kanser: AFP (Hati), CEA (Usus), Ca19.9 (Pancreas)",
      "CA12.5 (Ovari) — Wanita sahaja",
      "Ca15.3 (Buah Dada) — Wanita sahaja",
      "Pap Smear Surepath (Kanser Rahim)",
      "Percuma: Konsultasi Doktor, Pemeriksaan Fizikal, BMI, Mata & Komposisi Badan",
      "Percuma: Pemeriksaan Jantung (ECG) & X-Ray Dada",
      "Bonus Percuma: 1 Sesi Konsultasi Fisioterapi (20 minit)",
      "Digalakkan untuk wanita berumur 40 tahun ke atas",
    ],
    whatsappNumber: "60162235212",
  },
  {
  ...
  },
  {
    ...
    category: "Health Screenings",
    description:
      "Pakej saringan kesihatan khas untuk lelaki berumur 55 tahun ke atas. Merangkumi saringan sendi, tiroid, vitamin, mineral dan kanser. Termasuk vaksin influenza dan konsultasi fisioterapi percuma.",
    details: [
      "Saringan Kesihatan Asas",
      "Pemeriksaan Risiko Sakit Jantung (hs-TRP T)",
      "Saringan Keradangan Sendi (Rheumatoid Factor)",
      "Saringan Darah Tiroid (TSH, T4)",
      "Saringan Darah Paratiroid (iPTH)",
      "Saringan Vitamin D & Magnesium (kesihatan tulang)",
      "Saringan Vitamin Badan (Vitamin B & Kandungan Besi)",
      "Saringan Kanser: AFP (Hati), CEA (Usus), Ca19.9 (Pancreas), PSA (Prostate)",
      "Percuma: Konsultasi Doktor, Pemeriksaan Fizikal, BMI, Mata & Komposisi Badan",
      "Percuma: Pemeriksaan Jantung (ECG) & X-Ray Dada",
      "Bonus Percuma: 1 Sesi Konsultasi Fisioterapi (20 minit)",
      "Bonus Percuma: 1 Dos Vaksin Influenza",
      "Digalakkan untuk lelaki berumur 55 tahun ke atas",
    ],
    whatsappNumber: "60162235212",
  },
  {
    ...
    category: "Health Screenings",
    description:
      "Pakej saringan kesihatan khas untuk wanita berumur 65 tahun ke atas. Merangkumi saringan sendi, tiroid, vitamin, mineral dan kanser wanita. Termasuk vaksin influenza dan konsultasi fisioterapi percuma.",
    details: [
      "Saringan Kesihatan Asas",
      "Pemeriksaan Risiko Sakit Jantung (hs-TRP T)",
      "Saringan Keradangan Sendi (Rheumatoid Factor)",
      ...
      "Bonus Percuma: 1 Sesi Konsultasi Fisioterapi (20 minit)",
      "Bonus Percuma: 1 Dos Vaksin Influenza",
      "Digalakkan untuk wanita berumur 65 tahun ke atas",
    ],
    whatsappNumber: "60162235212",
  },
