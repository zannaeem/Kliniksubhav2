...
type SheetType = "call" | "map" | "whatsapp" | null;
    ...
    <>
      ...
      <div className="md:hidden fixed transform-gpu bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-[100] pb-[env(safe-area-inset-bottom)] shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)]">
        <div className="flex items-center justify-around h-[68px]">
          ...
          {/* WhatsApp — triggers bottom sheet */}
          <button
        ...
        <div className="px-6 pt-5 pb-10">
          ...
          <div className="space-y-3">
            <a
              ...
              rel="noopener noreferrer"
              onClick={close}
              className="flex items-center gap-4 w-full p-4 rounded-2xl border border-gray-100 bg-gray-50 hover:bg-[#25D366]/5 hover:border-[#25D366]/30 transition-all group"
            >
              <div className="w-11 h-11 rounded-full bg-[#25D366]/10 flex items-center justify-center shrink-0 group-hover:bg-[#25D366]/20 transition-colors">
              ...
              <svg className="ml-auto text-gray-300 group-hover:text-[#25D366] transition-colors" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M9 18l6-6-6-6"/></svg>
            </a>
