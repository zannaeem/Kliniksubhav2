  ...
  return (
    <div className="space-y-4">
      ...
      <a
        ...
        className="flex items-center justify-center gap-3 w-full bg-primary hover:bg-primaryDark active:bg-emerald-800 text-white font-bold px-6 py-4 rounded-2xl transition-colors text-base shadow-sm"
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        Book Appointment Online (Instant)
      </a>

      <div className="relative flex items-center py-4">
        <div className="flex-grow border-t border-gray-100"></div>
        <span className="flex-shrink-0 mx-4 text-gray-400 text-xs font-bold uppercase tracking-widest">Or Ask a Question</span>
        <div className="flex-grow border-t border-gray-100"></div>
      </div>
